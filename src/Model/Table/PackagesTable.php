 ...
 * Packages Model
 *
 * @property \App\Model\Table\PackageDataTable&\Cake\ORM\Association\BelongsTo $PackageData
...
class PackagesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->integer('package_data_id')
            ->notEmptyString('package_data_id');
    ...
    {
        $rules->add($rules->existsIn('package_data_id', 'PackageData'), ['errorField' => 'package_data_id']);

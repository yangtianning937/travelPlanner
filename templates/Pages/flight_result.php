...
<div class="main">
    ...
    <!-- table 展示 departure，destination，departure_time， destination_time，每个数据后都有booking按钮 -->
    <table>
        <tr>
            <th>Departure</th>
            <th>Destination</th>
        ...
        <tr>
            ...
            <td class="actions">
                    <?= $this->Html->link(__('Booking'), ['controller' => 'Flights', 'action' => 'save_flight', $flight->id]) ?>
                    </td>
        </tr>
    </table>
        <?php } ?>
